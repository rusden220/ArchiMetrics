...
namespace ArchiMetrics.CodeReview.Rules.Semantic
{
	...
	public class DoNotCallOverridableMembersInConstructorRule : SemanticEvaluationBase
	{
		...
		public override QualityAttribute QualityAttribute
		{
			get
			{
				return QualityAttribute.Modifiability | QualityAttribute.Maintainability;
			}
		}
